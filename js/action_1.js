...
function reset1() {
    for (var key in general_data) {
        ...
        for (var i = 0; i < general_data[key].btn_list.length; i++) {
            var btn_element = document.getElementById(general_data[key].btn_list[i]);
            if (i == 0) {
